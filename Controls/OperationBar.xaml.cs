...
{
    /// <summary>
    /// Строка управления операцией: «Начать» / «Пауза» / «Отмена».
    ...
    ///
    /// В «Проверке SHA-256» строка другая (две кнопки, без паузы) — подгонять её
    /// под общий контрол значило бы добавить больше параметров, чем экономится
    /// разметки.
    /// </summary>
