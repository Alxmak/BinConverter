...
{
    /// <summary>
    /// Кнопки управления операцией: «Начать» / «Пауза» / «Отмена», сверху вниз.
    /// Стоят на всех рабочих вкладках, в своей карточке справа от «Прогресса», —
    /// раньше «Проверка SHA-256» повторяла эти же кнопки своей разметкой, из-за
    /// чего они могли разъехаться по виду.
    ///
