...
namespace TweakFirmware.Views
{
    public partial class ShellWindow : FluentWindow
    {
        ...
        public ShellWindow()
        {
            ...
            // Вернулись к окну — красную полосу в панели задач можно гасить: она звала
            // именно сюда, дальше звать некуда.
            Activated += (_, _) => OperationLockService.Instance.ForgetLastResult();
